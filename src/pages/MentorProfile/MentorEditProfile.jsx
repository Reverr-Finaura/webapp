...
import styles from "./MentorEditProfile.module.css";
...
const MentorEditProfile = () => {
  ...
  // Remove Same domains Is Not Same domains
  useEffect(() => {
    setDomainList((prev) => {
      return prev.filter((domain) => {
        return !formData?.domain?.includes(domain.label);
      });
    });
  }, [formData?.domain]);
  ...
  const domainAdd = (domainName) => {
    setFormData((prev) => {
      return {
        ...prev,
        domain: [...prev?.domain, domainName],
      };
    });
    // Remove from domain list
    setDomainList((prev) => {
      return prev.filter((domain) => domain.label !== domainName);
    });
  };
  const domainRemove = (domainName) => {
    setFormData((prev) => {
      return {
        ...prev,
        domain: prev.domain.filter((domain) => domain !== domainName),
      };
    });
    // Add to domain list
    setDomainList((prev) => {
      return [...prev, { label: domainName }];
    });
  };
                ...
                <form>
                  ...
                  <div className="form-row">
                    ...
                    <input
                      ...
                      id="accountType"
                      name="bankAdress"
                      value={formData?.accountDetails?.bankAdress || ""}
                  ...
                  <div className="form-row">
                    ...
                    <input
                      ...
                      id="upiId"
                      name="upiId"
                      value={formData?.accountDetails?.upiId || ""}
                  ...
                  <div className="form-row">
                    ...
                    <input
                      ...
                      name="mentorCalendlyLink"
                      value={formData?.mentorCalendlyLink || ""}
