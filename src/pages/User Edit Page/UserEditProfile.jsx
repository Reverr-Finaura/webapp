...
const UserEditProfile = () => {
  ...
  const [userDefaultstartUpDocumentName, setUserDefaultStartUpDocumentName] =
    useState(userFundingDoc?.UploadedFileName);
  const [userDefaultstartUpDocumentURL, setUserDefaultStartUpDocumentURL] =
    useState(userFundingDoc?.UploadedFilePath);

  const [haveStartUpBtnClick, setHaveStartUpBtnClick] = useState(
    userDoc?.hasFundingProfile
  );
  ...
  const [startUpInfo, setStartUpInfo] = useState({
    startUpFullName: userFundingDoc?.FounderName,
    startUpProfessionalEmail: userFundingDoc?.ProfessionalEmail,
    startUpMobile: userFundingDoc?.ContactNumber,
    startUpLinkedIn: userFundingDoc?.LinkedinLink,
  });
  ...
  const uploadStartupRelevantFilesToFirebase = async () => {
    const fileReff = ref(
      storage,
      `FundingFiles/${startUpDocumentUpload.name + user?.user?.email}`
    );
    try {
        ...
        resp.items.forEach((item) => {
          if (
            item._location.path_.includes(
              startUpDocumentUpload.name + user?.user?.email
            )
          ) {
            getDownloadURL(item).then((url) => {
              // setStartupFilesUploadedUrl(url)
              uploadStartupDataToFirebase(
                url,
                startUpDocumentUpload.name + user?.user?.email
              );
            });
  ...
  async function updateUserDocInFirebase(item) {
    ...
    //META UPDATE
    let tempMeta = meta.map((item) => {
      if (item.email === user?.user?.email) {
        return { email: user?.user.email, phone: generalProfileInfo.phone };
      } else {
        return item;
      }
    });
    ...
    <>
      ...
      <section id='mentor-add-profile-page'>
        <section className='profile-info-section'>
          <h1 className='profile-info-section-title'>
          ...
          <div className='imageUploadInputContainer'>
            ...
            {imageUpload !== null && tempImageURL ? (
              <>
                <img
                  className='userUploadedImagePreview'
                  src={tempImageURL}
       ...
       <p className='imageUploadInputContainerText'>{imageUpload!==null?imageUpload?.name:"Add Photo"}</p> */}
          ...
          <div className='add-profile-info-form'>
            <input
              ...
              type='text'
              name='fullName'
              className='add-profile-input fullName-input'
            ...
            <div className='add-profile-info-form-grid'>
              <input
                ...
                type='text'
                name='dOB'
                className='add-profile-input DOB-input'
              ...
              <input
                ...
                type='text'
                name='gender'
                className='add-profile-input Gender-input'
                placeholder='Gender'
              ...
              <input
                ...
                type='text'
                name='stateOfUser'
                className='add-profile-input state-input'
                placeholder='State'
              ...
              <input
                ...
                type='text'
                name='country'
                className='add-profile-input country-input'
                placeholder='Country'
              ...
              <input
                ...
                type='text'
                name='designation'
                className='add-profile-input fullName-input state-input'
              ...
              <input
                ...
                type='text'
                name='phone'
                className='add-profile-input fullName-input country-input'
          ...
          <section className='how-you-want-to-meet-people'>
            <h1 className='how-you-want-to-meet-people-title'>
              How you want to meet people
            </h1>
            <div className='how-you-want-to-meet-people-form'>
              <div className='how-you-want-to-meet-people-form-input-cont'>
                ...
                />
                <img
                  className='how-you-want-to-meet-people-form-social-icon-img'
          ...
          <section id='know-about-your-education'>
            <h1 className='know-about-your-education-title'>
              Let’s know about your Education!
            </h1>
            {educationFormArray?.map((item) => {
              return (
                <>
                  <div
                    className='know-about-your-education-form read-only-form'
                    key={item.id}
                    id={item.id}
                  >
            ...
            <div
              onClick={addNewEducationFormInput}
              className='add-more-form-image-container'
            >
          ...
          <section id='professional-profile-section'>
            <h1 className='professional-profile-section-title'>
            ...
            {professionalFormArray?.map((item) => {
              return (
                <>
                  <div
                    className='professional-profile-section-form read-only-form'
                    key={item.id}
                    id={item.id}
                  >
            ...
            <div className='professional-profile-section-form'>
              ...
              <input
                ...
                className='professional-profile-form-input'
            ...
            <div
              onClick={addNewProfessionalFormInput}
              className='add-more-form-image-container'
            >
              {/* <img className='add-more-form-image-container-image' src="./images/addMorePlusIcon.png" alt="add-more-icon" /> */}
              <IoMdAddCircleOutline className='add-more-form-image-container-image-react-icon' />
          ...
          <section id='what-is-your-industry-section'>
            <h1 className='what-is-your-industry-title'>
              What is your Industry?
            </h1>
            <div className='what-is-your-industry-input'>
              {yourIndustry === "" ? "Choose Your Industry" : yourIndustry}
            </div>

            <div className='what-is-your-industry-options-cont'>
              <div
                onClick={() => setYourIndustry("Fintech")}
                className='what-is-your-industry-options'
              >
                Fintech
              </div>
              <div
                onClick={() => setYourIndustry("Sales")}
                className='what-is-your-industry-options'
              >
                Sales
              </div>
              <div
                onClick={() => setYourIndustry("Product Development")}
                className='what-is-your-industry-options pd-industry-option'
              >
                Product Development
              </div>
              <div
                onClick={() => setYourIndustry("Research")}
                className='what-is-your-industry-options'
              >
                Research
              </div>
              <div
                onClick={() => setYourIndustry("Legal")}
                className='what-is-your-industry-options'
              >
                Legal
              </div>
              <div
                onClick={() => setYourIndustry("Marketing")}
                className='what-is-your-industry-options'
              >
                Marketing
              </div>
              <div
                onClick={() => setYourIndustry("Fundraising")}
                className='what-is-your-industry-options'
              >
                Fundraising
              </div>
              <div
                onClick={() => setYourIndustry("Realtech")}
                className='what-is-your-industry-options'
              >
                Realtech
              </div>
              <div
                onClick={() => setYourIndustry("Edtech")}
                className='what-is-your-industry-options'
              >
                Edtech
              </div>
              <div
                onClick={() => setYourIndustry("Medtech")}
                className='what-is-your-industry-options'
              >
                Medtech
              </div>
...
{userDefaultstartUpDocumentName!==""||userDefaultstartUpDocumentName!==undefined||userDefaultstartUpDocumentName!==null?<p className='uploadDocumentFileName'>{userDefaultstartUpDocumentName}</p>:null}
          ...
          >
            <button
              ...
              className='mentor-add-profile-page-submit-button'
            >
              Submit
            </button>
            <p className='mentor-add-profile-page-submit-button-sub-text'>
