...
function App() {
  ...
  //     try {
  //       const data = await getDocs(query(userCollectionRef));
  //       const userdata = data.docs.map((doc) => ({
  //         ...doc.data(),
  //         id: doc.id,
  //       }));
  //       let staticDatalength = userdata.length;
  //       let userCount = 0;
  ...
  //         }
  //       });
  //       console.log(`Total users in Firestore: ${staticDatalength}`);
  //       console.log(`Total user accounts created: ${userCount}`);
  //     } catch (error) {
