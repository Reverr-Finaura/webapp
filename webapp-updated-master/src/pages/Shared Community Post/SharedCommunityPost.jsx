      ...
      <section id={styles.SharedCommunityPostSection}>
        <section className={styles.SharedCommunityPostContainer}>
          <div className={styles.UserProfilePopupTop}>
            <img
              onClick={() => window.location.replace(`${tempSiteUrl}`)}
          ...
          <div className={styles.overFlowContainer}>
            {singlepostDataa === null ||
            editSinglePostIsClick === true ? null : (
              <SharedPostCard
                item={singlepostDataa}
                postsData={postsData}
                setPostsData={setPostsData}
                setEditSinglePostIsClick={setEditSinglePostIsClick}
                handleEditSinglePost={handleEditSinglePost}
              />
            )}
                ...
                <section id={styles.editSinglePostSection}>
                  <div className={styles.editPostContainerEditContainer}>
                    <div
                      ...
                      onClick={() => {
                        setEditSinglePostIsClick(false);
