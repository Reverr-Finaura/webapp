...
const ChangePassword = () => {
  ...
  function handleChangePassBtnClick() {
    setLoading(true);
    if (
      changePassForm.confirmNewPass === "" ||
      changePassForm.newPass === "" ||
      changePassForm.oldPass === ""
    ) {
  ...
  return (
    <>
      ...
      <section id='changePassContainer'>
        ...
        <p className='changePassContainer_otp_send_message'>
          *OTP has been send to your registered mobile number and email address
        </p>
        <div className='changePassContainer-form'>
          <input
            ...
            name='oldPass'
            className='changePassContainer-input'
            value={changePassForm.oldPass}
          />
          <input
            onChange={handleChangePassFormInputChange}
            type='password'
          ...
          <button
            ...
            className='changePassContainer-button'
          >
            Change Password
          </button>
        </div>
